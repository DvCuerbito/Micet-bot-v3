        ...
        try {
            ...
            if (subCommand === 'pokedex' || subCommand === 'dex') {
              ...
              .join('\n')
                ...
                const texto = `𔖮๋ׅꉹ᮫ִׁ۫📕𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ *TU POKÉDEX* 𔖮๋ׅꉹ᮫ִׁ۫📕𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁

Total: ${userData.contador}/1010 Pokémon

${lista}

${userData.pokedex.length > 20? `\n_...y ${userData.pokedex.length - 20} más_` : ''}`
            ...
            const texto = `𔖮๋ׅꉹ᮫ִׁ۫🎰𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ *POKÉ GACHA* 𔖮๋ׅꉹ᮫ִׁ۫🎰𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁

𔖮๋ׅꉹ᮫ִׁ۫🍟𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ Nombre: *${nombre}* #${data.id.toString().padStart(3, '0')}
𔖮๋ׅꉹ᮫ִׁ۫🥪𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ Rareza: ${rareza}
𔖮๋ׅꉹ᮫ִׁ۫🫔𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ Tipo: ${tipos}
𔖮๋ׅꉹ᮫ִׁ۫🥙𐋕᮫ִׁ᷂𐴲᮫ִׁ╾᳞҇┄⵿֟፝━᮫๋࣭݁ Stats Total: ${statsTotal}

*Usa \`.reclamar\` para guardarlo*
