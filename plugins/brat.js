...
export default {
    ...
    async execute(sock, msg, options) {
        try {
            ...
            if (!text) {
                await sock.sendMessage(from, {
                    text: '❀ Por favor, ingresa un texto para crear el Sticker.',
                    contextInfo: {
            ...
            // Crear sticker usando la librería sticker.js
            const stickerBuffer = await sticker(response.data, null, customPackname, customAuthor);
